...
export default {
  ...
  methods: {
    loadScript() {
      ...
      window._bsa.init("custom", "CE7IC2QL", "placement:nodrocks", {
        forceReload: true,
        target: "#cutton-js",
        template: `
...
#cutton-js .native-button {
  z-index: 100;
  display: flex;
  padding: 12px 15px;
  border-radius: 6px;
  box-shadow: 0 1px 2px 0 rgba(60, 64, 67, 0.4), 0 2px 6px 2px rgba(60, 64, 67, 0.149);
  color: #fff;
...
#cutton-js .native-img {
  margin-right: 10px;
  width: 20px;
  height: 20px;
}

#cutton-js .native-overlay {
  text-align: left;
  width: 250px;
...
#cutton-js #native-button:checked + .native-overlay {
  opacity: 1;
  display: flex;
...
#cutton-js .native-banner {
  line-height: 1.35;
  padding: 20px 0px;
}

#cutton-js .native-tagline {
...
#cutton-js .native-description {
  margin-bottom: 10px;
  font-size: 16px;
}

#cutton-js .native-footer {
  display: flex;
  margin-top: 15px;
...
#cutton-js .native-logo {
  width: 120px;
  height: auto;
  margin-bottom: 10px;
}

#cutton-js .native-cta {
  padding: 6px 8px;
  border-radius: 3px;
